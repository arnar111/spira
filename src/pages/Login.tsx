...
import { clearLocalData, importSnapshot, recordCloudUpdatedAt } from '@/lib/sync';
...
export function Login({ onSignedIn }: LoginProps) {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      // Grunnlína fyrir pull-samanburð: þetta tæki er nú jafnt skýinu.
      recordCloudUpdatedAt(result.updated_at ?? null);
